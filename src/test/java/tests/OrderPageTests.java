...
public class OrderPageTests {
    ...
    public static Object[][] setDataForOrder() {
        return new Object[][]{
                {"Даниил", "Катанаев", "Москва, ул. Панина, д. 20, кв. 24", "Новогиреево", "89166900950", "01.04.2025", "двое суток", "чёрный жемчуг", "Тест"},
                {"Эльдар", "Рязанов", "Москва, ул. Пражкина, д. 25, кв. 11", "Китай-город", "89167893590", "01.05.2025", "трое суток", "серая безысходность", "Ожидаю доставку без задержек"},
        };
    }
